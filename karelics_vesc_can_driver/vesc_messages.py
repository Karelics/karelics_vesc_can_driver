#    This file contains the classes responsible for handling the decoding of
#    messages received from the VESCS over CAN and encoding data so that it can
#    be communicated with the VESCs over CAN.
#
