...
static const _VescStatus_type_support_symbol_names_t _VescStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, karelics_vesc_can_driver, msg, VescStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, karelics_vesc_can_driver, msg, VescStatus)),
  }
};
...
{
  return &::karelics_vesc_can_driver::msg::rosidl_typesupport_cpp::VescStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, karelics_vesc_can_driver, msg, VescStatus)() {
  return get_message_type_support_handle<karelics_vesc_can_driver::msg::VescStatus>();
}
