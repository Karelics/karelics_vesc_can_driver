...
copyright = '2020, Mart Moerdijk'
author = 'Mart Moerdijk'
...
htmlhelp_basename = 'karelics_vesc_can_driverdoc'
...
latex_documents = [
    (master_doc, 'karelics_vesc_can_driver.tex', 'karelics\\_vesc\\_can\\_driver Documentation',
     'Mart Moerdijk', 'manual'),
]
...
man_pages = [
    (master_doc, 'karelics_vesc_can_driver', 'karelics_vesc_can_driver Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'karelics_vesc_can_driver', 'karelics_vesc_can_driver Documentation',
     author, 'karelics_vesc_can_driver', 'One line description of project.',
     'Miscellaneous'),
]
